...
export const PydanticLogo: Component<{ className?: string }> = ({ className }) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 120 120" width="24" height="24" class={className}>
      <path
        fill="#E521E9"
